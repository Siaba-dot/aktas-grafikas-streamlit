...
# Mėnesio pavadinimai kilmininku (didžiosios raidės) – naudojami C7 įrašui "SAUSIO 1-31" ir pan.
MONTH_GEN_LT = {
    1: 'SAUSIO',
    2: 'VASARIO',
    3: 'KOVO',
...
# ========= Mėnesio teksto (kilmininkas + dienų intervalas) generavimas į C7 =========
def render_month_period_genitive(month:int, year:int) -> str:
    """
    Grąžina 'SAUSIO 1-31', 'VASARIO 1-29' (keliamais), 'BALANDŽIO 1-30' ir pan.
    Naudoja pasirinkto year/month paskutinę dieną (calendar.monthrange).
    """
...
if schedule_file and act_file:
    try:
        ...
        # Metai (lemia vasario 28/29 ir darbo dienas)
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            # ---- Įrašome mėnesio tekstą kilmininku su dienų intervalu į nurodytą langelį ----
            ws = writer.sheets[target_sheet_name]
            try:
                month_text = render_month_period_genitive(month_choice, year_choice)  # pvz., "SAUSIO 1-31"
