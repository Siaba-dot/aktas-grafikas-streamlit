...
# - Paliekamos 1–7 eilutės (viršutiniai įrašai) tose pačiose vietose
# - Lentelės antraštės: 8-oje eilėje; duomenys: nuo 9-os eilės
# - Periodiškumas ir Kaina eilutėse = Excel formulės (be jokių "final" skaičiavimų Python'e)
# - Galutinė suma po lentelės K stulpelyje (ir "Kaina" stulpelio apačioje)
# - Grafiko įkėlimas (.ods/.xlsx/.xls), A1 diapazonas, header wizard, filtrai išsaugoti
# - PVM netaikomas
...
# ========================= Šventinės (demo, per "Skaičiavimai" lapą) =========================
...
if schedule_file and act_file:
    try:
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            # 3) Skaičiavimai: Pir..Sek kiekiai mėnesyje (atėmus šventines) — dinaminės 365 formulės
